...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <!-- Google tag (gtag.js) -->
        <script async src="https://www.googletagmanager.com/gtag/js?id=G-CLF18XVKB7"></script>
        <script>
            window.dataLayer = window.dataLayer || [];
            function gtag(){dataLayer.push(arguments);}
            gtag('js', new Date());

            gtag('config', 'G-CLF18XVKB7');
        </script>

        <!-- Adsense tag -->
        <script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-8102754226679812" crossorigin="anonymous"></script>
    ...
    <body class="font-sans antialiased bg-bg-default text-text-primary">
        @inertia
    </body>
</html>
