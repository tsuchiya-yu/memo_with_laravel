...
<template>
    ...
    <div class='sm:pt-0 bg-gray-100 flex flex-col sm:justify-center items-center'>
        <div class='py-6 w-full bg-gray-100 sm:max-w-md overflow-hidden sm:rounded-lg text-right'>
            <Link
